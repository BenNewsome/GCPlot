...
Output_name = 'Surface_Absolute_difference_Boxplot.png'
...
#   posative_data = get_values( Posative_wd, species, group, month )
   ...
   species1_data = get_absolute_difference( normal_species1_data, negative_species1_data, debug=debug )
   species2_data = get_absolute_difference( normal_species2_data, negative_species2_data, debug=debug )
   species3_data = get_absolute_difference( normal_species3_data, negative_species3_data, debug=debug )
...
#   plot_title     = 'Surface ' + species +' average between ' + start_time + ' and '  + end_time   
   Y_axis_title   = 'Absolute difference ( ' + units +'  )'
   Y_axis_size    = '30'
   X_axis_size    = '30'
